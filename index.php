...
<body class="text-[#2d2d2d]">
    ...
    <header>
        ...
        <div class="grid grid-cols-6 gap-12 p-10 xsm:gap-14 "> <!-- BEGIN HEADER GRID 6 COLS-->
            ...
            <div class="flex items-center justify-center col-start-6 col-end-7 px-4 text-center duration-300 hover:text-slate-400">
                    ...
                    <div class="lg:px-1 md:px-1 sm:px-1 xsm:px-0"><a href="https://www.linkedin.com/in/mrbillbillings/" class="p-2">
                    ...
                    <div class="lg:px-1 md:px-1 sm:px-1 xsm:px-0"><a href="https://www.instagram.com/billwhomakesstuff/" class="p-2">
