...
<body class="text-[#2d2d2d]">
    <header>
        ...
        <div class="grid grid-cols-6 p-10 "> <!-- BEGIN HEADER GRID 6 COLS-->
            ...
            <div class="flex items-center justify-center w-auto h-auto col-start-4 col-end-5 text-center duration-300 hover:text-slate-400">
                    <a id="dropdown" href="#" class="tracking-tighter xsm:text-xs sm:text-base md:text-xl lg:text-xl ">Brand Identity Philosophy</a>
            </div>
            <div class="flex items-center justify-center w-auto h-auto col-start-5 col-end-6 text-center duration-300 hover:text-slate-400">
